...
const ThemeBtn1 = ({linkpath, text, width, height, extra=""})=>{

    return(
    <Link to={linkpath} className={`relative overflow-hidden group [box-shadow:1px_2px_3px_0px_#00000040] transition-all duration-1000 font-montserrate bg-[linear-gradient(90deg,_#FFFFFF_14.9%,_#D0EFFF_65.4%,_#A7E2FF_100%)] inline-flex justify-center rounded-full mt-2 sm:mt-0 items-center w-${width} h-[${height}] text-xl ${extra}`}>
