                ...
                >
                    ...
                    <div className='w-full flex justify-end'>
                        <div className='flex flex-col justify-center items-center font-montserrate'>
                            <p className="text-[3vw] text-themeDBlue text-end text-xs sm:text-sm tracking-widest mt-2 mb-1 sm:mt-4 sm:mb-2">{pageType === "Sponsors" ? "BECOME AN SPONSOR" : "READY TO COMPETE?"}</p>
