...
const Card = ({ text, number }) => (
    <div className='bg-white p-4 rounded-[2.3rem] [box-shadow:7px_3px_11px_0px_#00000026] flex flex-col items-center justify-center gap-2 min-w-[305px] aspect-square'>
