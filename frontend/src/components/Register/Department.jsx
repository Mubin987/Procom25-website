...
const Department = ({ setDepartment }) => {
    return (
        <div className="relative pl-10 mb-5 mt-20">
            <RegisterHeading heading={"department"} />
            ...
            <div className="absolute top-[36%] left-[-1%] flex h-7 w-7 items-center justify-center rounded-full bg-gradient-text font-bold text-white text-xl z-10">
                1
            </div>
            <div className="mt-5 bg-[linear-gradient(270deg,#0D32C5_0%,#1768DB_37.9%,#1E8AE9_93.9%,#23A7F4_100%)] bg-clip-text text-transparent font-bold">
                <p className="text-base max-w-[50%] italic">
