...
const Payment = ({ fileUrl, setFileUrl }) => {
  ...
  return (
    <div className="relative pl-10 mt-16">
        ...
        <div className="flex flex-col items-center rounded-lg bg-[linear-gradient(90deg,_#FFFFFF_14.9%,_#DCF4FF_100%)] p-6 pt-3 ml-3 cursor-pointer drop-shadow-lg">
          <div className="lg:w-60">
            <label htmlFor="file-input" className="flex flex-col items-center cursor-pointer">
              ...
              <div className="my-3">
                <img
                  src="./src/assets/upload_symbol.png"
          ...
          {fileName && fileUrl && (
            <div className="mt-2 text-center">
              <p className="text-[10px] bg-[linear-gradient(90deg,_#1F95ED_0%,_#2169D4_100%)] bg-clip-text text-transparent font-bold italic">
                File{" "}
                <a
                  href={fileUrl}
                  target="_blank"
      ...
      <div className="absolute top-[29px] left-[-1%] flex h-7 w-7 items-center justify-center rounded-full bg-[linear-gradient(90deg,_#1F95ED_0%,_#2169D4_100%)] font-bold text-white text-xl z-10">
        <span className="bg-[linear-gradient(90deg,_#FFFFFF_14.9%,_#D0EFFF_63.77%,_#A7E2FF_100%)] bg-clip-text text-transparent font-bold">
          4
        </span>
      </div>
