    ...
    <div className="flex flex-col gap-16">
      ...
      <div className="min-h-screen p-4 md:p-6 lg:p-8">
        <form id="procom-25-registration-form" className="mx-auto max-w-5xl relative mt-9">
          ...
          <div className="absolute left-10 top-[34px] bottom-28 sm:bottom-[3.5rem] md:bottom-12 lg:bottom-12 xl:bottom-4 border-l-4 border-dashed border-themeBlue md:left-10" />
          <div className="pl-4">
